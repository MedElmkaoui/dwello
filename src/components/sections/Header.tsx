...
function Header() {
  ...
  return (
    <header className='mb-12 relative'>
        <Nav />
        <div className="mt-12 grid lg:grid-cols-3 items-center justify-center">
        ...
        <div className='z-10 -mt-24 w-[80%] lg:w-[70%] mx-auto bg-secondary rounded-lg py-12 px-2.5 flex gap-8 flex-col md:flex-row justify-around md:absolute md:left-[15%] md:bottom-12 '>
